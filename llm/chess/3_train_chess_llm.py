...
class ChessLLMTrainer:
    def __init__(self,
                 # model_name: str  = "mistralai/Mistral-7B-Instruct-v0.3", #7B params
                 model_name: str  = "TinyLlama/TinyLlama-1.1B-Chat-v1.0", #1.1B params
                 # model_name: str  = "google/gemma-2b", #2b params
                 # model_name: str  = "microsoft/phi-2", #2.7B params
                 train_file: str  = "chess_train.jsonl",
                 val_file: str    = "chess_val.jsonl",
                 output_dir: str  = "./chess-tiny-llama",
                 num_train_epochs = 3,
                 learning_rate    = 2e-4,
                 batch_size       = 4, #2 for CPU
                 ):
    ...
    def setup_lora(self):
        ...
        self.model.enable_input_require_grads()  # Critical for gradient propagation
    ...
    def train(self):
        ...
        training_args = TrainingArguments(
            ...
            gradient_accumulation_steps=4,  # Increased from 4 to compensate for smaller batch size. 8 for CPU
            ...
            fp16=True,                     # Disabled fp16 for CPU training
        ...
        trainer = Trainer(
            ...
            processing_class=self.tokenizer,  # Replace tokenizer with processing_class
            #tokenizer=self.tokenizer,
